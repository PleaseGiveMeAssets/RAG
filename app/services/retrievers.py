...
def retriever_data(query: str, embedding):
    # 로컬 DB 불러오기
    ...
    retrievers = vectorstore.as_retriever(search_type="similarity", search_kwargs={"k": 5})  # 유사도 높은 5문장 추출
    retriever = retrievers.invoke(query)
    return retriever
